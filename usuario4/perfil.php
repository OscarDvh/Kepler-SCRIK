	      ...
	      $sql="SELECT *, case tipo when 1 then 'Administrador' when 2 then 'Control' when 3 then 'Vizualizador' when 4 then 'Control Administrador' END AS tipo FROM `usuarios` where nombre='$usuario'";
         	...
         	?>	
					<div align="center">
					 ...
					 <!--<tr><td>
						      <p   align="justify">Eres un usuario con los privilegios de <?php echo $resultado['tipo'] ?> dentro del SCRIK - SISTEMA DE CONTROL DE RECURSOS E INVENTARIOS KEPLER y perteneces al area de  <b><?php echo $resultado['departamento'] ?></b></h4>
				            </td></tr>
					<tr height="40px"><td >
