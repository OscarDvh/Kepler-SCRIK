            ...
            <li class="nav-item menu2">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="computo/"   style="font-size: 90%" >Computadoras y laptops</a>
            ...
            .tarjetas {
                ...
                <main>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-4">
                                   <div class="card bg-warning text-white shadow">
                                        <div class="card-body">   <img  src="../img/computadora.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="computo/index.php" >
                                ...
                                <div class="col-lg-6 mb-4">
                                  <div class="card bg-warning text-white shadow">
                                        <div class="card-body"><img  src="../img/celular.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="phone/index.php" >
												Equipos telefónicos</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
                                   <div class="card bg-warning text-white shadow">
                                        <div class="card-body"><img  src="../img/worker.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="personal/index.php" >
												Registros de colaboradores</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
                               <div class="col-lg-6 mb-4">
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"><img  src="../img/certificate.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="licencias/index.php" >Licencias de software</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
                                     <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/transmitter.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="servicios/" >
												Servicios de comunicaciónes</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
                               <div class="col-lg-6 mb-4">
                                   <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/list.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="stock/" >
												Mobiliario</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
								...
								<div class="col-lg-6 mb-4">
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/proveedor.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link " href="proveedores/" >
												Proveedores</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
								     ...
								     <div class="col-lg-6 mb-4">
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/coche.png" width="30px" class="img-negative">
                                            <a class="small tarjetas stretched-link" href="autos/" >
												Automóviles de la empresa</a>
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div> </main>
