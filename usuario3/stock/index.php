                ...
                <main>
					    ...
					    <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Registro del almacén de informática y comunicaciones
								    
                            </div> <div class="card-body"><table id="datatablesSimple">	<?php 

								require_once "../../conexion.php";
								$obj= new conectar();
								$conexion=$obj->conexion();

								$sql="SELECT * ,case estado when 1 then 'Nuevo' when 2 then 'Usado' when 3 then 'Dañado'  END AS estado FROM `stock`";
