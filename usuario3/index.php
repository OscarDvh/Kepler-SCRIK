                                ...
                                <div class="col-lg-6 mb-4">
                                   <div class="card bg-warning text-white shadow">
                                        <div class="card-body"><img  src="../img/worker.png" width="30px" class="img-negative">
                                            <a class="small tarjetas  stretched-link" href="personal/index.php" >Registro de colaboradores</a>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/transmitter.png" width="30px" class="img-negative">
                                            <a class="small tarjetas  stretched-link" href="servicios/" >Servicios de comunicaciónes</a>
								...
								<div class="col-lg-6 mb-4">
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/proveedor.png" width="30px" class="img-negative">
                                            <a class="small tarjetas  stretched-link" href="proveedores/" >Proveedores</a>
                                    ...
                                    <div class="card bg-warning text-white shadow">
                                        <div class="card-body"> <img  src="../img/coche.png" width="30px" class="img-negative">
                                            <a class="small tarjetas  stretched-link" href="autos/" >Automóviles de la empresa</a>
