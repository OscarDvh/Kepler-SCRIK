                ...
                <main>
					    ...
					    <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Tabla de licencias de software y sistemas 
                            ...
                            <div class="card-body"><table id="datatablesSimple">
								...
								$sql="SELECT `id_licencias`, `detalles`, `fecha_inicio`, `fecha_renova`, `clave`, `costo_inicial`, `costo_renova`, `provedores_id`, id_provedores, nombre
									FROM licencias
			...
			while ($mostrar=mysqli_fetch_array($result)) {
				...
				print '
                                        <tr>
                                           ...
                                           <td>'.$mostrar['costo_inicial'].'</td>
                                           <td>'.$mostrar['fecha_renova'].'</td>
                                           <td>'.$mostrar['costo_renova'].'</td>
                                           <td>'.$mostrar['nombre'].' </td>
                                           
									<td align="center"><acronym title="Ver más ">
									<a class="btn btn-primary btn-lg" type="button" href="vermas.php?ideditar='.$mostrar['id_licencias'].'" >
