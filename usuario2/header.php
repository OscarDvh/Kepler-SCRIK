...
<style type="text/css">
            ...
            <li class="nav-item menu2">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="/scrik/usuario2/computo/index.php"   style="font-size: 90%" >Computadoras y laptops</a>
                        <a class="collapse-item" href="/scrik/usuario2/phone/index.php"  style="font-size: 90%">Equipos telefónicos</a>
						<a class="collapse-item" href="/scrik/usuario2/perifericos/" style="font-size: 90%">Periféricos y otros </a>
                    </div>
                </div>
            </li>
			<!-- Nav Item - personal -->
            ...
            <li class="nav-item menu2">
                <a class="nav-link" href="/scrik/usuario2/personal/">
			...
			<!-- Nav Item - autos -->
                                <li class="nav-item menu2">
                <a class="nav-link" href="/scrik/usuario2/autos/"> <i class="fas fa-fw fa-car"></i>
                    <span>Autos</span></a>
            </li>
				<!--Nav Item - stock	--> 
                            <li class="nav-item menu2">
                <a class="nav-link" href="/scrik/usuario2/stock/">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown"> <a class="dropdown-item" href="/scrik/usuario2/perfil.php">
