...
//consulta para tener el codigo del propietario
    ...
    $max = mysqli_query( $conectar, "select MAX(cons) as cons from perifericos LIMIT 1" );
...
$directorio = $_SERVER['DOCUMENT_ROOT']."/scrik/admin/perifericos/php/doc/$codigo"; //Declaramos un  variable con la ruta donde guardaremos los archivos
...
$sql = "INSERT INTO `perifericos`(`id_perifericos`, `codigo`, `no_serie`, `caracteristicas`, `Estado`, `fecha`, `costo`, `personal_id`, `id_propietario`, `activo`, `cons`) VALUES                    (NULL,'$codigo','$no_serie','$caracteristicas','$estado','$fecha','$costo','$usuario','$propietario',1,'$cons');";
