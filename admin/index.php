...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Sidebar - Brand --> 
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#"> <img src="../img/logoblanco.png" width="100%"> </a> 
  ...
  <li class="nav-item menu2"> <a class="nav-link" href="stock/"> <i class="fas fa-fw fa-archive"></i> <span>Mobiliario</span></a> </li>
	...
	<!-- Nav Item - Maquinaria -->
  <li class="nav-item menu2"> <a class="nav-link" href="maquinaria/"> <i class="fas fa-fw fa-cogs"></i> <span>Maquinaria</span></a> </li>
        ...
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"> <img  src="../img/computadora.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="computo/" >Equipos de cómputo</a> </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"><img  src="../img/celular.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="phone/index.php" >Equipos telefónicos</a> </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"><img  src="../img/worker.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="personal/index.php" > Registros de personal con equipos</a>
          ...
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"><img  src="../img/certificate.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="licencias/index.php" >Licencias de software</a>
                <div class="text-white-50 small"></div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"> <img  src="../img/transmitter.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="servicios/" >Servicios de comunicaciónes</a>
                <div class="text-white-50 small"></div>
              </div>
            </div>
          </div>
            ...
            <div class="card bg-warning text-black shadow">
              <div class="card-body justify-content-center" > <img  src="../img/padlock.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="passw/" >Administración de contraseñas</a>
          ...
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"><img  src="../img/proveedor.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="proveedores/" >Proveedores</a>
                <div class="text-white-50 small"></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4 align-items-center" >
            <div class="card bg-warning text-white shadow">
              <div class="card-body"> <img  src="../img/list.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link " href="stock/" >Mobiliario</a>
                <div class="text-white-50 small"></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="card bg-warning text-white shadow">
              <div class="card-body"> <img  src="../img/digital-key.png" width="30px" class="img-negative"> <a class="small tarjetas stretched-link" href="setting/"> Configuraciones de accesos</a>
                <div class="text-white-50 small"></div>
              </div>
            </div>
          </div>
